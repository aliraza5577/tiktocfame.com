    ...
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            <form action="" method="post">
                ...
                <p class="auth-description">Enter your New Password to recover your account.<br>Don't have an account? <a href="{{url('register')}}">Sign Up</a></p>
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="password" name="newPassword" class="form-control m-b-md" id="newPassword" aria-describedby="newPassword">
                </div>
                <div class="auth-credentials m-b-xxl">
                    <label for="cPassword" class="form-label">Confirm Password</label>
                    <input type="password" name="cPassword" class="form-control m-b-md" id="cPassword" aria-describedby="newPassword">
                </div>
