...
<header class="sticky-header">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-12 top-bar-right">
                <a class="whatsapp-link" href="https://wa.me/+16479095451 " target="_blank">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" class="whatsapp-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="get-a-quote" data-bs-toggle="modal" data-bs-target="#quoteModal">Get Quote</a>
            </div>
        </div>
        {{-- End Top Bar --}}
                            ...
                            @if($mainCat->getSubCategory->isNotEmpty())
                                <div class="mega-menu">
                                    ...
                                    <div class="menu-column menu-column-last">
                                        <img src="{{ url('public/upload/category/'.$mainCat->featured_image) }}" alt="{{$mainCat->name}}" />
            ...
            <nav class="navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="menu">
                        ...
                        @foreach ($getMainCategories as $mainCat)
                            <li class="dropdown">
                                <a href="{{ url('collection/'.$mainCat->slug) }}" class="dropdown-toggle" data-bs-toggle="dropdown">{{$mainCat->name}}</a>
                                @if($mainCat->getSubCategory->isNotEmpty())
                                    <ul class="dropdown-menu">
                                        @foreach($mainCat->getSubCategory as $subCat)
                                            <li>
                                                <a href="{{ url('collection/'.$mainCat->slug.'/'.$subCat->slug) }}">{{$subCat->name}}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                @endif
